      ...
      <div className='w-full p-5 mt-10 space-y-12'>
        ...
        <div className='text-center'>
          ...
          <section className="max-w-6xl mx-auto flex overflow-x-auto gap-4 p-4">
            ...
            <img src="/slides.png" alt="slides" className="w-70 h-68 object-cover flex-shrink-0 rounded-lg transform transition-transform duration-300 hover:-translate-y-1" />
            ...
            <img src="/water-park-1.png" alt="water park theme" className="w-70 h-68 object-cover flex-shrink-0 rounded-lg transform transition-transform duration-300 hover:-translate-y-1" />
          </section>
