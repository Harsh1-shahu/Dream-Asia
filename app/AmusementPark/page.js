      ...
      <div className='w-full p-5 mt-10 space-y-12'>
        ...
        <div className='text-center'>
          ...
          <section className="max-w-4xl mx-auto flex overflow-x-auto gap-4 p-4">
            ...
            <img src="/giant-swing.jpg" alt="Giant Swing" className="w-70 h-68 object-cover flex-shrink-0 rounded-lg transform transition-transform duration-300 hover:-translate-y-1" />
            <img src="/giant-wheel.jpeg" alt="Giant Wheel" className="w-70 h-68 object-cover flex-shrink-0 rounded-lg transform transition-transform duration-300 hover:-translate-y-1" />
          </section>
          <section className='flex flex-col items-center mt-10'>
            <h1 className='text-2xl font-extrabold mb-10'>Find your way around...</h1>
            <img src='/adventure-1.jpg'
