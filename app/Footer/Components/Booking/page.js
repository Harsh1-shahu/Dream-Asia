...
const Booking = () => {
  return (
    <>
      ...
      <img
        src='/booking.jpg'
        className='w-full md:w-2/3 mx-auto h-40 object-cover' />

      <div className='w-full p-5 bg-[#F7F7F7]'>
        <div className='max-w-7xl mx-auto shadow-xl rounded-xl bg-white p-6 mb-10'>
          <h1 className='text-2xl font-InspireTWDC font-bold mb-4'>Cashless <span className='text-[#5972D8] underline'>Terms</span> And <span className='text-[#5972D8] underline'>Conditions</span> for Dreamasia</h1>
          <p className='mb-4'>
