...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      <img src='/boat.avif'
        className='w-full h-30 md:h-80 object-cover object-bottom' />

      <div className='w-full p-6 bg-[#F7F7F7]'>
        <div className='max-w-4xl mx-auto'>
          <h1 className='text-3xl font-extrabold text-center mb-4 text-blue-500'><span className='text-blue-800'>Contact</span> Dream Asia</h1>
          ...
          <section className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='w-auto mx-auto bg-white shadow-md rounded-md p-4 hover:shadow-xl'>
              ...
              <button
                ...
                className='bg-gradient-to-r from-blue-400 to-blue-800 text-white py-2 px-4 rounded transition'>Report Lost Item</button>
            </div>
