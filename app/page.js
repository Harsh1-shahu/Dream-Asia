  ...
  return (
    <div className="bg-[#F7F7F7]">
      ...
      <motion.div
        ...
        className="relative w-full p-4 mt-18 md:mt-0">
        {/* Background Image or Video */}
        {showVideo ? (
          <video
            ref={videoRef}
            src="/dream-asia-theme.mp4"
            autoPlay
            muted
            className="w-full h-60 md:h-134 object-cover object-bottom rounded-t-4xl md:rounded-b-[100px]"
          />
        ) : (
          <img
            src="/discover2.jpg"
        ...
        {/* Header Section - show only when image is visible */}
        {!showVideo && (
      ...
      {/* Navigation Section */}
      <div className='relative px-4 mt-28 md:mt-36'>
        {/* Background Image */}
        <motion.div
        ...
        >
          <img
            src='/character1.png'
            className='w-50 md:w-64 lg:w-90'
            alt='Character'
          />
        </motion.div>
        ...
        <div className="relative z-10 flex items-center justify-center md:justify-between flex-wrap gap-6 bg-grident py-8 px-4 md:px-20 rounded-2xl mx-auto max-w-4xl transition-all duration-300">
          ...
          <div className="flex flex-col items-center gap-3 bg-gradient-to-t from-yellow-50 to-yellow-100 py-4 px-10 rounded-2xl shadow-xl group transition duration-300">
            <GiCursedStar className="text-yellow-500 text-4xl group-hover:animate-bounce transition-transform duration-300" />
            <Link to="peaceOfMind" smooth={true} duration={300}>
          ...
          <div className="flex flex-col items-center gap-3 bg-gradient-to-t from-yellow-50 to-yellow-100 py-4 px-14 rounded-2xl shadow-xl group transition duration-300">
            <GiStarFormation className="text-yellow-500 text-4xl group-hover:animate-bounce transition-transform duration-300" />
      ...
      <section className="max-w-5xl mx-auto flex flex-wrap justify-center gap-6 p-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md w-72 transition hover:shadow-xl">
          <img src="/childs.jpeg" alt="Cool Kid" className="w-full h-28 object-cover rounded-md mb-3 transform transition-transform duration-300 hover:-translate-y-1" />
        ...
        {/* Awesome Adult Card */}
        <div className="bg-white p-4 rounded-lg shadow-md w-72 transition hover:shadow-xl">
          <img src="/adult.jpg" alt="Awesome Adult" className="w-full h-28 object-cover rounded-md mb-3 transform transition-transform duration-300 hover:-translate-y-1" />
      ...
      <Element name="Experience">
        <div className="bg-[#F9FAFB] py-10">
          ...
          <section className="max-w-5xl mx-auto flex flex-wrap justify-center gap-6 px-4">
            ...
            {/* Amusement Park */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden w-72 transition hover:shadow-xl">
              <img src="/slides.png" alt="Amusement Park" className="w-full h-40 object-cover transform transition-transform duration-300 hover:-translate-y-1" />
              <div className="p-4 text-center">
